...
describe("AgentReviewPage",()=>{
  it("renders a human-readable business event without technical message ids",async()=>{
    ...
    server.use(http.get("/api/review/candidates/c1/evidence",()=>HttpResponse.json({items:[{id:"technical-message-id-1",senderName:"项目经理",sentAt:"2026-08-03T08:30:00Z",messageType:"text",content:"水电主要工作今天完成。"}],total:2})));
